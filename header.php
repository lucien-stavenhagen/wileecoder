...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'wileecoder' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$wileecoder_description = get_bloginfo( 'description', 'display' );
			if ( $wileecoder_description || is_customize_preview() ) :
				?>
